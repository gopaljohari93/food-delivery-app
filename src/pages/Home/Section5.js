...
import DownloadImage from "../../assets/shop/e-shop.webp";
                ...
                <Container>
                    <Row className="align-items-center">
                        <Col lg={6} className="text-center text-lg-start mb-5 mb-lg-0">
                            ...
                            <h2>Save UP to 20%</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut dapibus tincidunt odio vehicula elementum. Pellentesque.
                            </p>
                            <Link to="/">
